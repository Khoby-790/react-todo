  ...
  return (
    <div className="bg-white py-5 flex justify-between items-center shadow-md">
      ...
      <div className="flex-1">
        <div className="bg-gray-300 group w-full flex  py-2 px-4  rounded-lg overflow-hidden">
          <div>
              <BsSearch className="text-gray-500" size={30} />
          </div>
          <input className="bg-gray-300 flex-1 text-gray-500 ml-3 outline-none" type="text" />
        </div>
      </div>
